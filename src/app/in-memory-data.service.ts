...
export class InMemoryDataService {
  ...
  createDb() {
    const students = [
      ...
      { id: '5', name: 'Rahul', rollNumber: 22, marks: [{ name: 'Telugu', marks: 23 }, { name: 'Physics', marks: 344 }, { name: 'Chemistry', marks: 44 }]},
      { id: '6', name: 'Rajiv', rollNumber: 22, marks: [{ name: 'Telugu', marks: 1 }, { name: 'Physics', marks: 33 }, { name: 'Chemistry', marks: 44 }]},
    ]
    return {students};
  }
}
